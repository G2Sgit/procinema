    ...
    <>
      ...
      <div className={css.top_container}>
        ...
        <p className={css.page_description_text}>
          ...
          production, Cinemart Production Services offer full production
          support. We can create best commercial films for your brand....
        </p>
      </div>
      <ul>
        ...
        <li className={css.service_unit}>
          <div className={css.service_unit_info}>
            ...
            />
            <p className={css.description_text}>
              Personalized approach, your budget is our priority. We will work
              together to create to ensure easiest ways to create films and
              commercials. Above all, we are friendly and highly professional
              and have the passion to make the shooting day an ultimate artistic
              experience. We cover Germany, Switzerland and Croatia, but also
              surrounding countries such as Slovenia, Bosnia and Herzegovina and
              Montenegro.
            </p>
            ...
            <p className={css.description_text}>
              ...
              Co-Production company. Croatian Government supports film making in
              Croatia by refunding the 25%-30% of the production expenses made
              in Croatia.
            </p>
        ...
        <li className={css.service_unit}>
          <div className={css.service_unit_info}>
            ...
            <p className={css.description_text}>
              For example, in Croatia, especially in Primorsko-Goranska County
              and Istria County, in contrast to other parts of the country,
              permit fees for filming are affordable and issued in very short
              period.
            </p>
          </div>
          <div className={css.unit_picture_thumb}></div>
        ...
        <li className={css.service_unit}>
          <div className={css.service_unit_info}>
            <h2 className={css.unit_title}>CAMERA, CREW & EQUIPMENT HIRE</h2>
            <UnderlinedHeading
              tag="h4"
            ...
            <p
              style={{ marginBottom: "25px" }}
              className={css.description_text}>
              Let us know of the equipment you need on set and we will provide
              it for you.
            </p>
            <p className={css.description_text}>
